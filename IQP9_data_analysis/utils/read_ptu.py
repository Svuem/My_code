...
# slightly adapted by Jonas Rauchfuss, University of Hamburg 2023
# to allow access from python file
...
def read_ptu(infile, outfile):
    ...
    outputfile = io.open(outfile, "w+", encoding="utf-16-le")
...
if __name__ == '__main__':
    read_ptu(sys.argv[1], sys.argv[2])